...
const LoginKid = () => {
	...
	const submitHandler = async (e) => {
		...
		const errorRes = await dispatch(loginKid(user));
	...
	return (
		<>
			<div className='container d-flex h-100-vh align-items-center'>
				<div className='w-50'>
					<Link to='/kid/signup' className='btn btn--rect btn--light'>
						Signup
					</Link>
					<Link to='/kid/login' className='btn btn--rect btn--1'>
						Login
					</Link>
