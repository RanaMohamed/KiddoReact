						...
						<div className='post-card post-card--bg post-card--bg--primary'>
							...
							<div className='post-card__body'>
								...
								<p>
									...
									mediocritatem. Sint rebum repudiandae vel ei. In mollis
									fuisset fierent pro, habemus dolores tincidunt ad nam. Vis
									laudem nostrud ex, augue errem indoctum ea eam.
								</p>
						...
						<div className='post-card__post'>
							...
							<div className='post-card__body'>
								...
								<p className='post-card__description'>
									...
									mediocritatem. Sint rebum repudiandae vel ei. In mollis
									fuisset fierent pro, habemus dolores tincidunt ad nam. Vis
									laudem nostrud ex, augue errem indoctum ea eam. Lorem ipsum
									dolor sit amet, vel id nusquam repudiandae interpretaris, eam
									an quem pericula. Mei te aliquid mediocritatem. Sint rebum
									repudiandae vel ei. In mollis fuisset fierent pro, habemus
									dolores tincidunt ad nam. Vis laudem nostrud ex, augue errem
									indoctum ea eam. Lorem ipsum dolor sit amet, vel id nusquam
									repudiandae interpretaris, eam an quem pericula. Mei te
									aliquid mediocritatem. Sint rebum repudiandae vel ei. In
									mollis fuisset fierent pro, habemus dolores tincidunt ad nam.
									Vis laudem nostrud ex, augue errem indoctum ea eam.
								</p>
								<div className='post-card__info'>
									<img
										className='post-card__avatar'
