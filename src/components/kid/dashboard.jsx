    ...
    <>
      <section className="d-flex justify-content-between my-lg">
        <div className="number-card coming-soon">
          ...
          <img src={process.env.PUBLIC_URL + "/imgs/level.svg"} alt="c"></img>
          <p className="number-card__number">Expert</p>
        </div>
        <div className="number-card">
          <h3 className="number-card__title">Interested Categories</h3>
          <img
            src={process.env.PUBLIC_URL + "/imgs/008-create.svg"}
            alt="c"
          ></img>
        ...
        <div className="number-card coming-soon">
          ...
          <img
            src={process.env.PUBLIC_URL + "/imgs/034-game-6.svg"}
            alt="c"
          ></img>
        ...
        <div className="number-card coming-soon">
          ...
          <img
            src={process.env.PUBLIC_URL + "/imgs/067-treasure-1.svg"}
            alt="c"
          ></img>
        ...
        <div className="number-card coming-soon">
          ...
          <img
            src={process.env.PUBLIC_URL + "/imgs/068-trophy.svg"}
            alt="c"
          ></img>
